...
function listarestudiante(){
	...
	$.get("ec",{opc:2},function(data){	
		...
		for(i=0;i<d.length;i++){
			...
			"</td><td><a href='#' style='color:green' onclick='modificar("+d[i].idestudiantes+")'><i class='far fa-edit'></i></a></td><td><a href='#' style='color:red' onclick='eliminar("+d[i].idestudiantes+")'><i class='far fa-trash-alt'></i></a></td></tr>")
			c++;
		}
	});
}
